<template>
  <div :class="containerClass">
    ...
    >
      ...
      >
      <span class="p-tree-filter-icon pi pi-search" />
    </div>
    <div
...
<script>
import TreeNode from './AppTreeNode.vue';
  ...
  computed: {
    ...
    filteredValue() {
      ...
      for (let node of this.value) {
        ...
        if ((strict &&
            (this.findFilteredNodes(_node, paramsWithoutNode) || this.isFilterMatched(_node, paramsWithoutNode))) ||
          (!strict &&
            (this.isFilterMatched(_node, paramsWithoutNode) || this.findFilteredNodes(_node, paramsWithoutNode)))) {
